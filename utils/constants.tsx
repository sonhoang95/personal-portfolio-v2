...
export const jobsData = [
  ...
  },
  {
    ...
    duties: [
      ...
      "Communicated frequently with multi-disciplinary teams of designers, SEO specialists, and throughout the marketing to come up with campaign strategies as well as Sitecore performance, resulted in better user experience and 30% increased traffic to the site",
    ],
    company: "CURO",
  },
  {
